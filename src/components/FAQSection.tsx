        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              <AccordionItem 
                key={index} 
                value={`item-${index}`}
                className="bg-surface-light rounded-lg px-6 border-0 shadow-card hover:shadow-hero transition-all duration-smooth"
              >
                <AccordionTrigger className="text-left text-text-primary hover:text-primary transition-colors py-6">
                  {faq.question}
                </AccordionTrigger>
          ...
          <div className="text-center mt-12">
            <p className="text-text-secondary">
              ...
              <a 
                href="#contacto" 
                className="text-primary hover:text-ai-blue-deep transition-colors font-medium"
              >
